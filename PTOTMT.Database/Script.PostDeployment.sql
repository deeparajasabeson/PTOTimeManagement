...
Values
(NEWID(), @UserId, @FlexTypeId, 'Sample Flex', 'Sample Description', 1, GETDATE(), GETDATE(), 2, @ReportToUserId, '00000000-0000-0000-0000-000000000000', GETDATE(), GETDATE(), @StatusId,1, @UserId, GETDATE(), @UserId, GETDATE())
